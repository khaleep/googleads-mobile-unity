...
namespace GoogleMobileAds.Api
{
    public class RewardedInterstitialAd
    {
        ...
        private static HashSet<IRewardedInterstitialAdClient> clients = new HashSet<IRewardedInterstitialAdClient>();
        ...
        public void Show(Action<Reward> userEarnedRewardCallback)
        {
            ...
            {
                rewardedInterstitialAdClient.Show(userEarnedRewardCallback);
            }
        }
